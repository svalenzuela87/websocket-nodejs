...
function testWebSocket() {
    ...
    websocket.addEventListener("open", (event) => {
        ...
        video.innerHTML +="<video autoplay muted loop controls style='width:100%'><source src = 'big_buck_bunny.mp4' type = 'video/mp4' frameborder='0' style='border:0'></source></video>";
    });
